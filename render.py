#!/usr/bin/env python3
"""
render.py — GrainRX: Apply physics-based film grain to an image.

Usage examples:

  # B&W Tri-X look
  python render.py photo.jpg -o grainy.jpg --profile tri-x --bw

  # Color Portra 400
  python render.py photo.jpg -o grainy.jpg --profile portra400
  ...
  python render.py photo.jpg -o grainy.jpg --mu-r 0.06 --sigma-r 0.02 --mc 200
  ...
  python render.py photo.jpg -o grain.jpg --profile portra400 --fast
